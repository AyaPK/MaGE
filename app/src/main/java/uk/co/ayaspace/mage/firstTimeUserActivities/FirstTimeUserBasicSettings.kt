...
class FirstTimeUserBasicSettings : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        whatIsBackedUp.setOnClickListener {
            val informationDialog = InformationDialog(resources.getString(R.string.what_is_backed_up_in_the_cloud))
            informationDialog.show(supportFragmentManager, "")
        }

        nextButton.setOnClickListener {
            val intent = Intent(this, FirstTimeUserConfirmation::class.java)
